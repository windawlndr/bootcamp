...
public class E2E_Web {
    ...
    public void startBrowser() {
        ...
        System.getProperty("webdriver.chrome.driver","/Users/dev2000325/bootcamp/Testing/winda-restassured/chromedriver-mac-arm64");
    ...
    @Test(dependsOnMethods = "clickButtonValid")
    public void assertSuccess() throws Exception {
        ...
        Assert.assertEquals("Products", infoText.getText());
    }

    @Test(dependsOnMethods = "assertSuccess")
    ...
    public void getCart() throws Exception {
        ...
        .findElement(By.cssSelector("#shopping_cart_container > a"));
        checkCart.click();
    }
